...
<body id="page-top">
		...
		<div class="container-fluid">
			...
			<form name="cadastro_cliente" method="post" action="formulario_cad_cliente.php">
				...
				<div class="form-group col-md-4">
						...
						<input type="text" class="form-control" name="nome_cliente" placeholder="ISBN do livro"maxlength="15">
				</div>
				<div class="form-group col-md-4">
					<label for="inputAddress2">Nome Aluno</label>
					<input type="text" class="form-control" name="end_rua_cliente" placeholder="Nome do aluno" maxlength="20">
				 </div>
				</div>
			...
			<input type="text" class="form-control" name="end_rua_cliente" placeholder="Turma do aluno" maxlength="25">
			</div>
	...
	<div class="form-row">
				...
				<div class="form-group col-md-3">
					...
					<input class="form-control" type="datetime-local" name="dt_hora_emprestimo" />
				</div>
		</div>
		...
		<div class="container my-auto">
			...
			<span>Copyright &copy; Unopar 2019</span>
			</div>
		</div>
		</footer>
		<!-- End of Footer -->
