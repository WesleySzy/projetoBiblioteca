			...
			<form name="cadastro_cliente" method="post" action="formulario_cad_cliente.php">
				<div class="form-row">
					<div class="form-group col-md-2">
							...
							<input type="text" class="form-control" name="nome_cliente" placeholder="Inserir o ISBN" maxlength="15">
					</div>
					<div class="form-group col-md-4">
						<label for="inputAddress2">Nome do livro</label>
						<input type="text" class="form-control" name="end_rua_cliente" placeholder="Inserir o nome do livro" maxlength="20">
				</div>          
				</div>
				...
				<div class="form-row">
					...
					<input type="text" class="form-control" name=" " placeholder="Inserir o nome do aluno" maxlength="50">
				</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="form-group col-md-2">
						...
						<input type="text" class="form-control" name="end_rua_cliente" placeholder="Inserir turma do aluno" maxlength="20">
				</div>
